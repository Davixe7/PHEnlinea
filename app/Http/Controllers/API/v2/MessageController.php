...
class MessageController extends Controller
{
  ...
  public function show(BatchMessage $batch_message){
    return response()->json(['data'=>$batch_message]);
  }
  ...
  public function create(Request $request){
    ...
    $instance_validated = $this->whatsapp->validateInstance($instance_id, $phone);

    if( $instance_id && !$instance_validated ){
    ...
    return response()->json([
      'data' => compact('extensions', 'instance_id', 'phone', 'message')
    ]);
  }
